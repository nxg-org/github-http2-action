...
const OriginalAgent = __nccwpck_require__(8605).Agent;
...
const OriginalHttpsAgent = __nccwpck_require__(7211).Agent;
...
const http2wrapper = __nccwpck_require__(2766);
const lowercaseKeys = __nccwpck_require__(9662);
const is_1 = __nccwpck_require__(7678);
...
const QuickLRU = __nccwpck_require__(9273);
const Http2ClientRequest = __nccwpck_require__(1031);
const calculateServerName = __nccwpck_require__(1691);
const urlToOptions = __nccwpck_require__(1878);
...
const {Agent, globalAgent} = __nccwpck_require__(4882);
const IncomingMessage = __nccwpck_require__(9570);
const urlToOptions = __nccwpck_require__(1878);
const proxyEvents = __nccwpck_require__(2938);
const isRequestPseudoHeader = __nccwpck_require__(2807);
const {
...
const http2 = __nccwpck_require__(7565);
const agent = __nccwpck_require__(4882);
const ClientRequest = __nccwpck_require__(1031);
const IncomingMessage = __nccwpck_require__(9570);
const auto = __nccwpck_require__(6858);
...
// See https://github.com/facebook/jest/issues/2549
// eslint-disable-next-line node/prefer-global/url
const {URL, urlToHttpOptions} = __nccwpck_require__(8835);
const http = __nccwpck_require__(8605);
const https = __nccwpck_require__(7211);
const resolveALPN = __nccwpck_require__(6624);
const QuickLRU = __nccwpck_require__(9273);
...
const {isIP} = __nccwpck_require__(1631);
...
const http2 = __nccwpck_require__(4645);
...
const newRequest = async ({url, method, data, http2, body, headers}) => {
  try {
    ...
    actions.debug(JSON.stringify({url, method, data, http2, body, headers}))
